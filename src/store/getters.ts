...
export const playHistory = (state: any) =>
  state.playHistory.map((song: any) => new Song(song))
export const favoriteList = (state: any) =>
  state.favoriteList.map((song: any) => new Song(song))
